...
Fireworksはモダンなブラウザ（Chrome、Firefox、Edgeなど）で動作するよう設計されています。Safariでも動作しますが、最新バージョンを推奨します。

### 花火のアニメーションをカスタマイズできますか？
はい！`FireworkScene.vue`でThree.jsのパラメータを変更することで、色やサイズ、打ち上げパターンを自由にカスタマイズできます。
